...
public class TripDaoJdbcImpl implements TripDao {
	...
	public List<Trip> findByClosingDateOpenStatus(Date actualDate) {
		return jdbcTemplate.queryForList(
				"TRIP_FIND_BY_BEFORECLOSINGDATE_OPENSTATUS", 
				new TripMapper(),actualDate);
	}
	...
	@Override
	public List<Trip> findByUserIdAndStatusOpenOrClose(Long id) {
		return jdbcTemplate.queryForList(
				"TRIP_FIND_BY_USERID_STATUSOPENORCLOSE", 
				new TripMapper(),
				id);
	}
	...
	public List<Trip> findByUserIdAndStatusDone(Long id) {
		return jdbcTemplate.queryForList(
				"TRIP_FIND_BY_USERID_STATUSDONE", 
				new TripMapper(),
				id);
	}
